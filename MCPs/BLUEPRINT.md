...
Verified live: official April statement for owner 150916883 = $1,777.73 net. Cross-check showed the
synthesizer diverges badly ($4,011, 8 vs 3 bookings) because it ignores owner expenses and groups
bookings by stay-date overlap rather than OwnerRez's statement rules — so the synthesizer is labeled a
ROUGH ESTIMATE and the official endpoint is the source of truth.
