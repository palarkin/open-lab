...
export function registerGuestTools(server) {
    server.registerTool("ownerrez_search_guests", {
        title: "Search Guests",
        ...
        try {
            let items = await orPaged("/guests", { q });
            if (limit)
    ...
    server.registerTool("ownerrez_get_guest", {
        title: "Get Guest",
