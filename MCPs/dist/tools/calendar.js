...
export function registerCalendarTools(server) {
    ...
    server.registerTool("ownerrez_get_availability", {
        title: "Get Availability",
        description: "Show what's booked/blocked for a property in a date range (OwnerRez has no calendar endpoint; " +
    ...
    server.registerTool("ownerrez_update_rate", {
        title: "Update Rate (spot rate)",
        description: "Set the nightly rate for specific dates on a property (spot rates). Without confirm=true it only " +
